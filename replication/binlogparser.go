...
func (p *BinlogParser) parseEvent(h *EventHeader, data []byte, rawData []byte) (Event, error) {
	...
	if h.EventType == FORMAT_DESCRIPTION_EVENT {
		...
		if h.EventType == ROTATE_EVENT {
			// log.Info("==========================ROTATE_EVENT==========================")
			e = &RotateEvent{}
		} else if !p.rawMode {
			switch h.EventType {
			case QUERY_EVENT:
				// log.Info("==========================QUERY_EVENT==========================")
				e = &QueryEvent{}
			case XID_EVENT:
				// log.Info("==========================XID_EVENT==========================")
				e = &XIDEvent{}
			case TABLE_MAP_EVENT:
				// log.Info("==========================TABLE_MAP_EVENT==========================")
				te := &TableMapEvent{}
